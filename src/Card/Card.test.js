...
describe('Card test', () => {
  ...
  it('should render the correct', () => {
    const renderedCard = shallow(<Card type='Card compared' data={[]}/>);
  ...
  it('should render the correct', () => {
    const renderedCard = shallow(<Card type='Card displayComparedData'
                                       data={[]}
                                       district1="Colorado" 
                                       district2='ADAMS COUNTY 14' 
                                       compareData={{Colorado: 0.62, ['ADAMS COUNTY 14']: 0.54, compared: 0.72}}/>);
  ...
  it('should call the method passed from props in the onClick', () => {
    ...
    const renderedCard = shallow(<Card type='Card' district="Colorado" selectCard={mockFunc} data={[]}/>);
